            ...
            {[
              {
                name: 'Community',
                price: '$250',
                perks: ['Logo on website', 'Thank-you on social'],
              },
              {
                name: 'Builder',
                price: '$500',
                perks: ['Logo on website', 'Social shoutout', 'Branded swag item'],
              },
              {
                name: 'Maker',
                price: '$1,000',
                highlight: true,
                perks: ['Logo on website', 'Social shoutout', 'Workshop slot', 'Branded swag item'],
              },
              {
                name: 'Founding',
                price: '$2,500',
                perks: ['Naming rights', 'All Maker perks', 'Dedicated table', 'Hiring access'],
              },
            ].map((tier) => (
              <div
                key={tier.name}
                style={{
                  background: tier.highlight
                    ? 'linear-gradient(135deg, var(--bg-card) 0%, rgba(196,255,80,0.06) 100%)'
                    : 'var(--bg-card)',
                  border: `1px solid ${tier.highlight ? 'var(--border-accent)' : 'var(--border)'}`,
                  borderRadius: '12px',
                  padding: '1.5rem',
                  display: 'flex',
              ...
              >
                ...
                <div>
                  <p style={{ fontSize: '0.75rem', fontFamily: 'DM Mono, monospace', color: 'var(--text-muted)', letterSpacing: '0.1em', marginBottom: '0.3rem' }}>
                    {tier.name.toUpperCase()}
                  </p>
                  <p style={{ fontSize: '1.6rem', fontWeight: 300, letterSpacing: '-0.03em', color: tier.highlight ? 'var(--accent)' : 'var(--text-primary)' }}>
                    {tier.price}
                  </p>
                </div>
                ...
                <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.45rem' }}>
                  {tier.perks.map((perk) => (
                    <li key={perk} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.85rem', color: 'var(--text-muted)' }}>
                      <svg width="12" height="12" viewBox="0 0 14 14" fill="none" aria-hidden="true" style={{ flexShrink: 0, color: 'var(--accent)' }}>
